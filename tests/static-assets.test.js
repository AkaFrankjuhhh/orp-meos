...
test("Discord bot exposes training request dropdown and trainer info overview", () => {
  ...
  assert.match(envExample, /DISCORD_TRAINING_REQUEST_MENTOR_TRAJECT_ROLE_ID=/);
  ...
  assert.match(workerCode, /Discord rol:\*\* niet ingesteld/);
  ...
  assert.match(workerCode, /label: "Mentor-Traject"/);
