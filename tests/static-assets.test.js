...
test("MEOS concept is wired as primary overheid surface", () => {
  ...
  assert.match(html, /meos\.css\?v=20260818-entry-permissions-security/);
  assert.match(html, /meos\.js\?v=20260818-entry-permissions-security/);
  ...
  assert.match(envExample, /MEOS_DELETE_ROLE_IDS=/);
