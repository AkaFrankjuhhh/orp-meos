...
const organizationConfigs = {
  defensie: {
    ...
    rankTrainingRequirements: {
      ...
      Wachtmeester: ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "__PROMOTION_TASK__"],
      "Wachtmeester 1ste Klasser": ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "__PROMOTION_TASK__"],
      Opperwachtmeester: ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "SIV", "__PROMOTION_TASK__"],
      Adjudant: ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "SIV", "__PROMOTION_TASK__"],
      Kornet: ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "SIV", "__PROMOTION_TASK__"],
      "Tweede-Luitenant": ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "SIV", "OGM", "__PROMOTION_TASK__"],
      "Eerste-Luitenant": ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "SIV", "OGM", "__PROMOTION_TASK__"],
      Kapitein: ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "SIV", "OGM", "__PROMOTION_TASK__", "__MAJOR_LEADERSHIP__"],
      Majoor: ["BKV", "IBT", "Mentor-Traject", "KW", "OPS", "TMO", "OPCO", "SIV", "OGM", "SMG", "__PROMOTION_TASK__", "__MAJOR_LEADERSHIP__"],
    ...
    discord: {
      ...
      taskRoleMappings: [
        ...
        { key: "directie-operatie", label: "Directie Operatie", envKey: "DISCORD_OPERATIE_LEIDING_ROLE_ID", defaultRoleId: "1426544464293527684" },
        { key: "teamchef-operatie", label: "Teamchef Operatie", envKey: "DISCORD_OPERATIE_LEIDING_ROLE_ID", defaultRoleId: "1426544464293527684" },
        { key: "coordinator-operatie", label: "Co\u00f6rdinator Operatie", envKey: "DISCORD_OPERATIE_LEIDING_ROLE_ID", defaultRoleId: "1426544464293527684" },
        { key: "directie-w-s", label: "Directie W&S", envKey: "DISCORD_WS_MANAGEMENT_ROLE_ID", defaultRoleId: "1425219423849152512" },
        { key: "teamchef-w-s", label: "Teamchef W&S", envKey: "DISCORD_WS_MANAGEMENT_ROLE_ID", defaultRoleId: "1425219423849152512" },
        { key: "coordinator-w-s", label: "Co\u00f6rdinator W&S", envKey: "DISCORD_WS_MANAGEMENT_ROLE_ID", defaultRoleId: "1425219423849152512" },
        { key: "directie-otc", label: "Directie OTC", envKey: "DISCORD_OTC_LEIDING_ROLE_ID", envFallbackKeys: ["DISCORD_OTC_MANAGEMENT_ROLE_ID"], defaultRoleId: "1425219424872300667" },
        { key: "teamchef-otc", label: "Teamchef OTC", envKey: "DISCORD_OTC_LEIDING_ROLE_ID", envFallbackKeys: ["DISCORD_OTC_MANAGEMENT_ROLE_ID"], defaultRoleId: "1425219424872300667" },
        { key: "coordinator-mentor", label: "Co\u00f6rdinator Mentor", envKey: "DISCORD_OTC_LEIDING_ROLE_ID", envFallbackKeys: ["DISCORD_OTC_MANAGEMENT_ROLE_ID"], defaultRoleId: "1425219424872300667" },
        { key: "coordinator-trainer", label: "Co\u00f6rdinator Trainer", envKey: "DISCORD_OTC_LEIDING_ROLE_ID", envFallbackKeys: ["DISCORD_OTC_MANAGEMENT_ROLE_ID"], defaultRoleId: "1425219424872300667" },
        { key: "mentor-leiding", label: "Mentor-Leiding", envKey: "DISCORD_MENTOR_LEIDING_ROLE_ID" },
        { key: "otc-leiding", label: "OTC-Leiding", envKey: "DISCORD_OTC_LEIDING_ROLE_ID", defaultRoleId: "1425219424872300667" },
        { key: "w-s-leiding", label: "W&S-Leiding", envKey: "DISCORD_WS_LEIDING_ROLE_ID" },
        { key: "iz-leiding", label: "IZ-Leiding", envKey: "DISCORD_IZ_LEIDING_ROLE_ID" },
        { key: "trainer-leiding", label: "Trainer-Leiding", envKey: "DISCORD_TRAINER_LEIDING_ROLE_ID" },
        { key: "dsi-leiding", label: "DSI-Leiding", envKey: "DISCORD_DSI_LEIDING_ROLE_ID" },
        { key: "dsi", label: "DSI", envKey: "DISCORD_DSI_ROLE_ID" },
        { key: "klu-leiding", label: "KLu-Leiding", envKey: "DISCORD_KLU_LEIDING_ROLE_ID" },
        { key: "klu", label: "KLu", envKey: "DISCORD_KLU_ROLE_ID" },
  ...
  politie: {
    ...
    discord: {
      ...
      taskRoleMappings: [
        { key: "interne-zaken", label: "Interne-Zaken", envKey: "DISCORD_POLITIE_INTERNE_ZAKEN_ROLE_ID" },
        { key: "ovj", label: "OvJ", envKey: "DISCORD_POLITIE_OVJ_ROLE_ID" },
        { key: "hovj", label: "hOvJ", envKey: "DISCORD_POLITIE_HOVJ_ROLE_ID" },
        { key: "trainer", label: "Trainer", envKey: "DISCORD_POLITIE_TRAINER_ROLE_ID" },
        { key: "mentor", label: "Mentor", envKey: "DISCORD_POLITIE_MENTOR_ROLE_ID" },
